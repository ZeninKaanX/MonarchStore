...
export async function signInLocalAccount(storage, usernameInput, password) {
  ...
  if (!account) {
    throw new Error("Kullanıcı adı veya şifre bu cihazda bulunamadı.");
  }
...
export function bindLocalAccountUI({ button, dialog, closeButton, form, usernameInput, passwordInput, confirmInput, title, description, submitButton, switchButton, logoutButton, notify }) {
