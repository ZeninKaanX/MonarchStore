...
const { create2FASync } = require('./src/admin-2fa')
...
const admin2FA = create2FASync(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY)
...
client.once('clientReady', async (readyClient) => {
  ...
  if (admin2FA) admin2FA.start(readyClient, GUILD_ID)
