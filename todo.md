...
- [x] Bot ve mağaza tarafını birim testleri, sözdizimi/üretim derlemesi ve tarayıcı görünümüyle doğrulamak; ardından kullanıcıya yalnızca değişen bot dosyalarını ve yerel güncelleme adımlarını vermek. _(20 bot testi; mağazada 7 Vitest testi, TypeScript kontrolü, derleme ve masaüstü/mobil görünüm geçti. `index.js` ile yeni `src/community-stats.js` kullanıcıya ayrı dosyalar olarak verildi.)_

- [x] Mevcut beyaz saçlı askerî anime karakterin yüzünü, kıyafetini ve soğuk savaş komuta merkezi atmosferini koruyan kısa, sessiz ve döngüye uygun hero videosu üretmek. _(Kullanıcı, sağlanan hareketlendirme promptuyla 10 saniyelik kaynak videoyu üretti; görünür Gemini logosu temizlenmiş sürümde kaldırıldı.)_
- [x] Yeni hero videosunu masaüstü/mobil Monarch Store paneline erişilebilir ve performans dostu biçimde yerleştirmek; ardından test edip GitHub Pages’e aktarmak. _(Hero paneline sessiz otomatik/döngülü oynatma, statik poster yedeği ve `prefers-reduced-motion` koruması eklendi; GitHub Pages canlı HTML’i video varlığını döndürüyor.)_
